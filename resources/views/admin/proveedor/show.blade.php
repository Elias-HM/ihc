...
@section('title', "Información de Proveedores")
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-7">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a>{{ $proveedor->nombre }}</a>
                    </li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8 pl-lg-5">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h4>Informaci&oacute;n del proveedor</h4>
                                </div>
                            </div>
                            <div class="profile-feed">
                                <div class="d-flex align-items-start profile-feed-item">
                                    <div class="form-group col-md-6">
                                        ...
                                        <p class="text-muted">
                                            @if ( $proveedor->telefono != '' ) {{ $proveedor->telefono }} @else
                                            &nbsp; @endif
                                        </p>
                                        <hr>
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <p class="text-muted">
                                            @if ( $proveedor->direccion != '' ) {{ $proveedor->direccion }} @else
                                            &nbsp; @endif
                                        </p>
                                        <hr>
                                        ...
                                        <p class="text-muted">
                                            @if ( $proveedor->email != '' ) {{ $proveedor->email }} @else &nbsp;
                                            @endif
                                        </p>
                                        <hr>
                                    </div>
                ...
                <div class="card-footer text-muted">
                    <a href="{{ route('proveedores.index') }}" class="btn btn-danger float-right">
