        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('clientes.index') }}">Cliente</a>
                    </li>
                    <li class="breadcrumb-item active"><a>Registrar Cliente</a></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card-text">
                        <form id="frmCliente" action="{{ route('clientes.store') }}" method="POST"
                                ...
                                <div class="tab-content" bis_skin_checked="1">
                                    <div class="tab-pane active" id="tab_1" bis_skin_checked="1">
                                        <div class="text-center">
                                            <img src="{{URL::asset('/resources/img/ayuda-cliente-basico.gif')}}"
                                    ...
                                    <div class="tab-pane" id="tab_2" bis_skin_checked="1">
                                        <div class="text-center">
                                            <img src="{{URL::asset('/resources/img/ayuda-cliente-completo.gif')}}"
