...
class UpdateProveedorRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'documento' => 'required|string|min:11|unique:proveedors,documento,' . $this->route('proveedor')->id . '|max:11',
            'direccion' => 'nullable|string|max:255',
            'telefono' => 'nullable|string|min:9|unique:proveedors,telefono,' . $this->route('proveedor')->id . '|max:9',
            'email' => 'nullable|email|string|unique:proveedors,email,' . $this->route('proveedor')->id . '|max:255',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'telefono.max' => 'El \'Telefono\' debe de contener 11 caracteres',
            'telefono.min' => 'El \'Telefono\' debe de contener 11 caracteres',
